(() => {
  ...
  const translations = {
    pt: {
      ...
      legacyEyebrow: "Legado Vivo",
      legacyTitle: "Um patrimônio musical em movimento",
      legacyText1: "Entre rodas de samba, estúdio, grupo próprio e canções gravadas por grandes intérpretes, Edney Fernandes construiu uma obra sensível, popular e profundamente brasileira.",
      legacyText2: "Hoje, esse legado segue vivo através da curadoria da família, da organização do catálogo e da preservação de um repertório que ainda pode ganhar novas interpretações.",
      stat1Number: "Décadas",
      stat1Label: "de legado musical preservado",
      stat2Number: "Catálogo vivo",
      stat2Label: "obras, gravações e registros organizados",
      stat3Number: "Novas vozes",
      stat3Label: "interpretações, gravações e continuidade artística",
      ...
      catalogCardTitle: "Quer gravar uma obra?",
      catalogCardText: "Entre em contato para conhecer composições disponíveis, possibilidades de licenciamento e caminhos de interpretação do catálogo.",
      catalogCardCta: "Entrar em contato",
    ...
    en: {
      ...
      legacyEyebrow: "Living Legacy",
      legacyTitle: "A musical heritage in motion",
      legacyText1: "Between samba circles, studio sessions, his own group and songs recorded by major artists, Edney Fernandes built a body of work that was sensitive, popular and deeply Brazilian.",
      legacyText2: "Today, that legacy lives on through family curation, catalog organization and the preservation of a repertoire ready for new interpretations.",
      stat1Number: "Decades",
      stat1Label: "of musical legacy preserved",
      stat2Number: "Living catalog",
      stat2Label: "works, recordings and organized archives",
      stat3Number: "New voices",
      stat3Label: "interpretations, recordings and artistic continuity",
      ...
      catalogCardTitle: "Interested in recording a song?",
      catalogCardText: "Get in touch to discover available compositions, licensing possibilities and paths for new interpretations.",
      catalogCardCta: "Get in touch",
    ...
    es: {
      ...
      legacyEyebrow: "Legado Vivo",
      legacyTitle: "Un patrimonio musical en movimiento",
      legacyText1: "Entre rodas de samba, estudio, grupo propio y canciones grabadas por grandes intérpretes, Edney Fernandes construyó una obra sensible, popular y profundamente brasileña.",
      legacyText2: "Hoy, ese legado sigue vivo a través de la curaduría de la familia, la organización del catálogo y la preservación de un repertorio que todavía puede ganar nuevas interpretaciones.",
      stat1Number: "Décadas",
      stat1Label: "de legado musical preservado",
      stat2Number: "Catálogo vivo",
      stat2Label: "obras, grabaciones y archivos organizados",
      stat3Number: "Nuevas voces",
      stat3Label: "interpretaciones, grabaciones y continuidad artística",
      ...
      catalogCardTitle: "¿Quieres grabar una obra?",
      catalogCardText: "Ponte en contacto para conocer composiciones disponibles, posibilidades de licencia y caminos de interpretación del catálogo.",
      catalogCardCta: "Entrar en contacto",
