(() => {
  ...
  const translations = {
    pt: {
      ...
      impact1Number: "+6M",
      impact1Label:
        "de visualizações em interpretações das músicas do catálogo",
      impact2Number: "44",
      ...
      publishersEyebrow: "Catálogo em Editoras e Entidades",
      ...
      catalogText1:
        "Este não é apenas um memorial. É também um catálogo vivo, com composições que podem voltar ao mundo em novas gravações, arranjos e projetos.",
      catalogText2:
        "Para artistas, intérpretes, produtores e parceiros interessados, este espaço apresenta um repertório com identidade, emoção e história.",
      ...
      memorialEyebrow: "Arquivo Afetivo",
      ...
      curationEyebrow: "Curadoria & Estrutura",
      curationTitle: "Uma iniciativa Laiá Music",
      curationText1:
      ...
      contactText:
        "Para imprensa, parcerias, gravações, licenciamento ou contato institucional, fale com a curadoria do projeto.",
    ...
    en: {
      ...
      heroSubtitle:
        "Edney Fernandes' legacy lives on, connecting memory, catalog and new interpretations.",
      ...
      manifestoP2:
        "Edney Fernandes was one of those voices. An artist who transformed feelings into melody, everyday life into poetry and memory into song.",
      manifestoP3:
        "This project is a reunion between past and future: a place to preserve his work, present his journey and open paths for new voices.",

      relevanceEyebrow: "Reach & Relevance",
      relevanceTitle: "The permanence of the work",
      relevanceLead:
        "Edney Fernandes' catalog remains active in the collective imagination, on digital platforms, in performers' repertoires and in the emotional circuit of samba and pagode.",
      impact1Number: "+6M",
      ...
      publishersEyebrow: "Catalog in Publishers and Entities",

      journeyEyebrow: "Journey & Collaborations",
      journeyTitle: "A real presence in Brazilian music",
      journeyLead:
        "Across phonographic projects, samba circles, studios and artistic encounters, Edney Fernandes built a living trajectory within Brazilian popular music.",
      feature1Title: "Ed & A Tripulação",
      feature1Text:
        "Lead singer, guitarist and songwriter in a landmark São Paulo pagode project.",
      feature2Title: "Terra Brasil — Pagode de Mesa 3",
      feature2Text:
        "Participation as assistant producer and percussionist in a relevant phonographic project of the genre.",

      artistsEyebrow: "Major Performers",
      artistsTitle: "Songs that remained alive in other voices",
      artistsLead:
        "Original songs interpreted by relevant artists of Brazilian samba and pagode.",

      discographyEyebrow: "Discography",
      discographyTitle: "Projects that shaped a journey",
      discographyLead:
        "A selection of works that presents Edney Fernandes' artistic strength across group recordings, catalog songs and the posthumous project.",

      catalogEyebrow: "Living Catalog",
      catalogTitle: "Works open to new interpretations",
      catalogText1:
        "This is not only a memorial. It is also a living catalog, with songs that can return to the world through new recordings, arrangements and projects.",
      catalogText2:
        "For artists, performers, producers and partners, this space presents a repertoire with identity, emotion and history.",
      ...
      audioLead:
        "Previews, recordings and compositions that reveal the emotional texture of the work.",

      memorialEyebrow: "Affective Archive",
      memorialTitle: "Presences that remain",
      memorialLead:
        "Personal photographs, encounters and intimate fragments of a journey that remains alive.",

      curationEyebrow: "Curation & Structure",
      curationTitle: "An initiative by Laiá Music",
      curationText1:
        "This project is dedicated to organizing, preserving and activating the artistic legacy of Edney Fernandes.",
      curationText2:
        "Developed by Laiá Music, the memorial transforms memory, body of work and trajectory into a living system, connecting past, present and new possibilities within Brazilian music.",

      contactEyebrow: "Contact",
      contactTitle: "Talk about the legacy",
      contactText:
        "For press, partnerships, recordings, licensing or institutional contact, speak with the project's curatorship.",
    ...
    es: {
      ...
      heroSubtitle:
        "El legado de Edney Fernandes sigue vivo, conectando memoria, catálogo y nuevas interpretaciones.",
      heroCtaPrimary: "Explorar catálogo",
      ...
      manifestoP2:
        "Edney Fernandes fue una de esas voces. Un artista que transformaba sentimientos en melodía, la vida cotidiana en poesía y la memoria en canción.",
      manifestoP3:
        "Este proyecto es un reencuentro entre pasado y futuro: un espacio para preservar su obra, presentar su trayectoria y abrir camino a nuevas voces.",

      relevanceEyebrow: "Alcance & Relevancia",
      relevanceTitle: "La permanencia de la obra",
      relevanceLead:
        "El catálogo de Edney Fernandes sigue activo en el imaginario colectivo, en plataformas digitales, repertorios de intérpretes y en el circuito afectivo del samba y del pagode.",
      impact1Number: "+6M",
      impact1Label:
        "de visualizaciones en interpretaciones de canciones del catálogo",
      impact2Number: "44",
      impact2Label: "obras registradas oficialmente",
      impact3Number: "Años 90–Hoy",
      impact3Label: "presencia continua en el samba y pagode brasileño",
      publishersEyebrow: "Catálogo en Editoras y Entidades",

      journeyEyebrow: "Trayectoria & Colaboraciones",
      journeyTitle: "Presencia real en el circuito de la música brasileña",
      journeyLead:
        "Entre proyectos fonográficos, rodas de samba, estudio y encuentros artísticos, Edney Fernandes construyó una trayectoria viva dentro de la música popular brasileña.",
      feature1Title: "Ed & A Tripulação",
      feature1Text:
        "Vocalista, guitarrista y compositor en un proyecto emblemático del pagode paulista.",
      feature2Title: "Terra Brasil — Pagode de Mesa 3",
      feature2Text:
        "Participación como productor asistente y percusionista en un proyecto fonográfico relevante del género.",

      artistsEyebrow: "Grandes Intérpretes",
      artistsTitle: "Canciones que siguieron vivas en otras voces",
      artistsLead:
        "Obras autorales interpretadas por artistas relevantes del samba y del pagode brasileño.",

      discographyEyebrow: "Discografía",
      discographyTitle: "Proyectos que marcaron una trayectoria",
      discographyLead:
        "Una selección de obras que presenta la fuerza artística de Edney Fernandes entre grupo, catálogo y el proyecto póstumo.",

      catalogEyebrow: "Catálogo Vivo",
      catalogTitle: "Obras abiertas a nuevas interpretaciones",
      catalogText1:
        "Esto no es solo un memorial. También es un catálogo vivo, con composiciones que pueden volver al mundo en nuevas grabaciones, arreglos y proyectos.",
      catalogText2:
        "Para artistas, intérpretes, productores y aliados, este espacio presenta un repertorio con identidad, emoción e historia.",
      ...
      audioLead:
        "Previews, registros y composiciones para presentar la textura emocional de la obra.",

      memorialEyebrow: "Archivo Afectivo",
      memorialTitle: "Presencias que permanecen",
      memorialLead:
        "Fotografías personales, encuentros y fragmentos íntimos de una trayectoria que sigue viva.",

      curationEyebrow: "Curaduría & Estructura",
      curationTitle: "Una iniciativa de Laiá Music",
      curationText1:
        "Este proyecto se dedica a organizar, preservar y activar el legado artístico de Edney Fernandes.",
      curationText2:
        "Desarrollado por Laiá Music, el memorial transforma memoria, obra y trayectoria en un sistema vivo, conectando pasado, presente y nuevas posibilidades dentro de la música brasileña.",

      contactEyebrow: "Contacto",
      contactTitle: "Conversa sobre el legado",
      contactText:
        "Para prensa, alianzas, grabaciones, licencias o contacto institucional, habla con la curaduría del proyecto.",
  ...
  const bindLightbox = () => {
    ...
    items.forEach((item) => {
      item.addEventListener("click", () => {
        const img = $("img", item);
        if (img?.src) open(img.src, img.alt || "");
      });
    });
