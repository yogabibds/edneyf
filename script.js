...
const translations = {
  pt: {
    ...
    "hero.title": "Honrando o passado. Inspirando o futuro.",
    ...
    "hero.badge1": "Gestão de catálogo",
    "hero.badge2": "Consultoria musical",
    "hero.badge3": "Parcerias culturais",
    "hero.ctaPrimary": "Agendar conversa",
    "hero.ctaSecondary": "Conheça a LAIA",
    "hero.ctaCatalog": "Explorar legado",
    "hero.cardTitle": "Uma plataforma construída sobre experiência real",
    "hero.cardText": "A partir da gestão do legado de Edney Fernandes, a LAIA Music amplia sua atuação para outros artistas, catálogos e projetos que precisam de estrutura, direção e expansão cultural.",
    ...
    "services.item4Title": "Coaching e posicionamento",
    "services.item4Text": "Apoio no desenvolvimento artístico, narrativa, imagem e construção de presença.",
  ...
  es: {
    ...
    "hero.title": "Honrando el pasado. Inspirando el futuro.",
    ...
    "hero.badge1": "Gestión de catálogo",
    "hero.badge2": "Consultoría musical",
    "hero.badge3": "Alianzas culturales",
    "hero.ctaPrimary": "Agendar reunión",
    "hero.ctaSecondary": "Conocer LAIA",
    "hero.ctaCatalog": "Explorar legado",
    "hero.cardTitle": "Una plataforma construida sobre experiencia real",
    "hero.cardText": "A partir de la gestión del legado de Edney Fernandes, LAIA Music amplía su actuación hacia otros artistas, catálogos y proyectos que necesitan estructura, dirección y expansión cultural.",
    ...
    "services.item3Text": "Orientación estratégica para artistas, familias, productores y proyectos culturales.",
    "services.item4Title": "Coaching y posicionamiento",
    "services.item4Text": "Apoyo en el desarrollo artístico, narrativa, imagen y construcción de presencia.",
    ...
    "legacy.copy": "Con obras registradas, interpretaciones por artistas reconocidos y relevancia continua dentro del universo del samba y el pagode, el acervo de Edney Fernandes es hoy un ejemplo concreto de cómo un legado puede organizarse, valorizarse y expandirse.",
    "legacy.cta1": "Ver catálogo",
    "legacy.cta2": "Hablar sobre un catálogo",

    "institute.eyebrow": "Ecosistema",
    "institute.title": "Más allá de la música",
    "institute.text": "LAIA Music también se conecta con iniciativas de impacto cultural, como el Instituto Edney Fernandes, ampliando el alcance de la música hacia educación, memoria, innovación y economía creativa.",
    "institute.cardTitle": "Instituto Edney Fernandes",
  ...
  en: {
    ...
    "hero.title": "Honoring the past. Inspiring the future.",
    ...
    "hero.badge1": "Catalog management",
    "hero.badge2": "Music consulting",
    "hero.badge3": "Cultural partnerships",
    "hero.ctaPrimary": "Schedule a Call",
    "hero.ctaSecondary": "Discover LAIA",
    "hero.ctaCatalog": "Explore the Legacy",
    "hero.cardTitle": "A platform built on real-world experience",
    "hero.cardText": "Through the management of Edney Fernandes’ legacy, LAIA Music expands its work to other artists, catalogs, and projects that need structure, direction, and cultural expansion.",
    ...
    "services.item4Title": "Coaching and positioning",
    "services.item4Text": "Support in artistic development, narrative, image, and presence building.",
...
const counterObserver = new IntersectionObserver((entries, observer) => {
  entries.forEach((entry) => {
    ...
    if (!Number.isNaN(endValue)) animateCounter(element, endValue);
